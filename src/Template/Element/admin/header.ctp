<?= $this->Html->script('http://maps.google.com/maps/api/js?key=AIzaSyCPVcH4gGQwkl6bAxZTLmedAIqJPwNi73w&sensor=true'); ?>
...
<nav class="navbar navbar-static-top" role="navigation">
  ...
  <div class="navbar-custom-menu">
    ...
    <li><a href="<?= Configure::read('FRONT_URL') ?>" target="blanck">Access Site</a></li>
