    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    <a href="<?= Configure::read('ADMIN_URL');?>/profile" class="btn btn-app btn-flat"><i class="fa fa-folder"></i> List</a>
                    <a href="<?= Configure::read('ADMIN_URL');?>/profile" class="btn btn-app bg-maroon btn-flat"><i class="fa fa-exclamation"></i> Cancelar</a>
                </div><!-- /.box-body -->
            </div><!-- /.box /.box-info -->
        </div><!-- col-md-3 -->
    </div><!-- row -->
