    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-flat pull-left btn-lg" data-dismiss="modal">Cancel</button>
...
<script type="text/javascript">
    $(".delete-btn").click(function(){
        $("#ajax_button").html("<a href='/admin/users/delete/"+ $(this).attr("data-id")+"' class='btn btn-danger btn-flat btn-lg'>Confirm</a>");
        $("#trigger").click();
    });
</script>
